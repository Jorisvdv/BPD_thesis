...
from Models.CombinedClasifier import CombinedClassifierWithLoss
...
static_checkpoint = getRecentCheckpoint(
    r"Z:\joris.vandervorst\logs\NN_Clasifier\combined_loader_v3"
)
LSTM_checkpoint = getRecentCheckpoint(
    "Z:/joris.vandervorst/logs/LSTM_Clasifier_SpO2/load60_clip_1_512_1_AEpretrained_L1_unfreeze"
)
...
# %%
model = CombinedClassifierWithLoss(
...
model_name = "Combined_Clasifier_SpO2"
run_name = f"lstm_512_1_AEpretrained_L1_freeze"
