...
LSTM_checkpoint = getRecentCheckpoint(
    r"Z:\joris.vandervorst\logs\LSTM_Clasifier_SpO2_FiO2\CNN_64_hidden_32_loss"
)


# Instantiate AE_model
model_AE = CNNAutoencoderWithLoss.load_from_checkpoint(CHECKPOINT_encoder)
...
run_name = f"three_layers_NN64_loss"
